    ...
    return (
      ...
      <Grid container maxWidth="lg" spacing={4} >
              <Grid item lg={7} >
                ...
                <Typography variant='h5' gutterBottom fontFamily="Rye" textAlign="left" >Professional Catering Services </Typography>
              ...
              <Box className="right-head"  >
                  ...
                  <img src={InsuvaiLogo} alt='Project-box' style={{ width:"600px", height:"600px" , }} />
                  </Box>
              </Grid>
          ...
          <Grid container spacing={2} pt={5} >
             ...
             <Grid item lg={3}  pr="10px" >
              <Card sx={{  boxShadow :"4px 2px 8px #ccc" , border:"3px solid  rgb(108, 13, 196)", alignSelf:"stretch"}}>
