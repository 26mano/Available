...
const ProjectService = () => {
    ...
    return (
        <div>
            <Helmet>
                <title> Project Box | Final year Projects </title>
            </ Helmet>
          ...
          <h3>- transition type: ease-out</h3>
            ...
            <Grid container maxWidth="lg" spacing={2} sx={{ width:"100%", height:"100%", justifyContent:"center", alignItems:"center" }} >
                    <Grid item lg={6}  >
                      ...
                      <Button variant="outlined" sx={{ color:"azure", border:"2px solid white" , justifyContent:"space-around" }} href="tel:+919444208901" >
