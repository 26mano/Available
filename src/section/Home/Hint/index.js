...
const index = () => {
    return (
        <div>
             <div  style={{ width:"100%",height:"100%", backgroundColor:"white", borderRadius:"0% 0% 0% 20% ", marginTop:"5%" }} >
        <Grid  >
{/* --------------------------------For Mobile--------------------------------------------------- */}
...
{/* ----------------------------------For Desktop--------------------------------------------------- */}
         <Box sx={{ height:"100%", display:{xs:" none" , md:"flex", lg:"flex"},  justifyContent:"center", textAlign:"center",  }} >
